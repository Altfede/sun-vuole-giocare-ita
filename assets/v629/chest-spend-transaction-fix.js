...
function bind(){var bs=d.querySelectorAll('#v628B [data-v628b]');for(var i=0;i<bs.length;i++){var b=bs[i];if(b.__v629)continue;b.onclick=function(){buy(this.getAttribute('data-v628b'))};b.__v629=true}}
