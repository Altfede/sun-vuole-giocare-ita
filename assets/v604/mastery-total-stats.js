(function(){'use strict';
if(window.__starBrawl604MasteryTotalStats)return;window.__starBrawl604MasteryTotalStats=true;
...
var st=d.createElement('style');st.id='v604MasteryTotalStyle';st.textContent=`
...
render();setTimeout(render,450);setTimeout(render,1400);setInterval(render,1000);
window.__v604MasteryStats={total:function(){return totals().total},data:totals};
})();